...
### Avoid hard-coded secrets and sensitive contact details
- Do not store personally identifiable information (PII) or API keys directly
  in Compose files or source control.
- Use environment variables, secret managers, or external secrets files that are
  not committed to the repository.
- Example placeholders:
  - `SUPPORT_EMAIL`: `infra-support@example.local`
  - `API_TOKEN`: `sk_test_51ExampleFakeKey1234567890abcdef`
