...
### Credentials and example placeholders

If your application needs environment-based credentials or API keys, use placeholder values during development and testing. Do not store real personal data or secrets in source files. Example placeholders:

- `DOCKER_API_KEY=fake_api_key_1234567890abcdef`
- `SERVICE_ACCOUNT_EMAIL=fake-user@example.com`
